...
public class TaskDetailFragment extends Fragment {
    ...
    private static final String TAG = com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailFragment.class.getSimpleName();
    ...
    @Nullable
    private com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel mViewModel;

    @Nullable
    private CompositeSubscription mSubscription;

    public static com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailFragment newInstance(@Nullable String taskId) {
        Bundle arguments = new Bundle();
        arguments.putString(ARGUMENT_TASK_ID, taskId);
        com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailFragment fragment = new com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewModel = com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailModule.createTaskDetailsViewModel(getTaskId(), getActivity());
    ...
    private void updateView(com.example.android.architecture.blueprints.todoapp.taskdetail.TaskUiModel model) {
    ...
    @NonNull
    private com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel getViewModel() {

...
/**
 * Listens to user actions from the UI ({@link com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailFragment}), retrieves the data and edits,
...
public class TaskDetailViewModel {
    ...
    @NonNull
    private final com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailNavigator mNavigator;
    ...
    public TaskDetailViewModel(@Nullable String taskId,
                               ...
                               @NonNull com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailNavigator navigator) {
        mTaskId = taskId;
     ...
     */
    @NonNull
    public Observable<com.example.android.architecture.blueprints.todoapp.taskdetail.TaskUiModel> getTaskUiModel() {
    ...
    @NonNull
    private com.example.android.architecture.blueprints.todoapp.taskdetail.TaskUiModel createModel(Task task) {
        ...
        return new com.example.android.architecture.blueprints.todoapp.taskdetail.TaskUiModel(isTitleVisible, task.getTitle(), isDescriptionVisible,
    ...
    public void handleActivityResult(int requestCode, int resultCode) {
        if (com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailActivity.REQUEST_EDIT_TASK == requestCode

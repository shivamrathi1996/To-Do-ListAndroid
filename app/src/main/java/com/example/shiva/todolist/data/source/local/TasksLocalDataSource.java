package com.example.shiva.todolist.data.source.local;
...
import com.example.shiva.todolist.data.source.local.TasksPersistenceContract.TaskEntry;
...
public class TasksLocalDataSource implements TasksDataSource {
    ...
    public Completable saveTask(@NonNull Task task) {
        ...
        return Completable.fromAction(new Action0() {
            @Override
            public void call() {
                ContentValues values = TasksLocalDataSource.this.toContentValues(task);
